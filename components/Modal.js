    ...
    <Backdrop onClick={handleClose}>
      {type === "dropIn" && (
        <motion.div
          ...
          className="rounded-xl flex flex-col sticky justify-center bg-white dark:bg-[#1d2226] w-full max-w-lg md:-mt-96 mx-6"
          variants={dropIn}
          initial="hidden"
          animate="visible"
          exit="exit"
      ...
      {type === "gifYouUp" && (
        <motion.div
          className="rounded-lg flex bg-[#252c31] w-full max-w-6xl -mt-[7vh] mx-6 "
          onClick={(e) => e.stopPropagation()}
          variants={gifYouUp}
          initial="hidden"
          animate="visible"
