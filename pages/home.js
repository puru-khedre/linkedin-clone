...
import logo from "../public/LI_Logo.svg";
import homeIllus from "../public/homeIllus.svg";
          ...
          <div className="pl-4 flex items-center space-x-4">
            {Object.values(providers).map((provider) => (
              <div key={provider.name}>
                <button
                  className="text-blue-700 font-semibold rounded-full border border-blue-700 px-5 py-1.5 transition-all hover:border-2 hover:px-[calc(1.25rem-1px)]"
